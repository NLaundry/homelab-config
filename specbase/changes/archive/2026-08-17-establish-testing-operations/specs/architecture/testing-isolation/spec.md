...
The repository keeps candidate systems and their traffic inside disposable test boundaries so a test cannot reconfigure its compute provider or escape onto the physical homelab network.
