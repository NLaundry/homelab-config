...
The NAS operates a constrained testing account and Samba principal whose lifecycle can be managed without granting interactive authority or exposing secret material through the repository toolchain.
