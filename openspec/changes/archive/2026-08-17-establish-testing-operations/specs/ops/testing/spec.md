...
The repository provides distinct, predictable stages for fast validation, complete non-live testing, and checking the deployed homelab. Operators can run the whole safe gate or select focused evidence without accidentally addressing a live system.
