...
The NAS realizes the live SMB fixture boundary as a hidden, authenticated, capacity-bounded, auditable endpoint with exact recovery for the disposable state it owns.
